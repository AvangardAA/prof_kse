...
auto Client::send_to_exchange(const std::string& request) -> std::string_view
{
    try
    {
...
auto Auth::work(const std::string& choice) -> std::string
{
    std::string login{};
    std::string password{};
...
auto Auth::validate_response(const std::string_view& response) -> std::optional<bool>
{
...
auto TInterfaces::work() -> std::optional<std::string>
{
...
auto TInterfaces::validate_response(const std::string_view& response) -> void
{
    std::println("{}", response);
}

auto TInterfaces::view_market() -> std::string
{
...
auto TInterfaces::form_order() -> std::string
{
    std::string type{};
    std::string instrument{};
